...
class BIM(BatchAttack):
    ...
    def __init__(self, model, batch_size, dataset, session, loss, goal, distance_metric, iteration_callback=None):        
        ''' Initialize BIM.
        ...
        self.loss = loss(self.model)(self.xs_adv_model, self.ys_var)
