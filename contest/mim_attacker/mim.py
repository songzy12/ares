...
class MIM(BatchAttack):
    ...
    def __init__(self, model, batch_size, dataset, session, loss=CrossEntropyLoss, goal='ut', distance_metric='l_inf', iteration_callback=None):
        ''' Initialize MIM.
        ...
        cur_loss = self.loss(self.model)(self.xs_adv_model, self.ys_var)
        grad = tf.gradients(cur_loss, self.xs_adv_var)[0]
